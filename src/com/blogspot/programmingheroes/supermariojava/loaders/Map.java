...
public class Map 
{
    ...
    public void addPlayer(Player player) 
    {
        ...
        {
            System.err.println("No more players allowed in"+" this map. Only "+players.size()+".");
	}
        else 
        {
    ...
    {
        return !movingX && (p.getX()-xMap >= getDisplayableWidth()/2) && (xMap < getWidth()-getDisplayableWidth());
    }
    ...
    {
        return !movingY && (p.getY()-yMap >= getDisplayableHeight()/2)&& (yMap < getHeight()-getDisplayableHeight());
    }

...
public class Background 
{
    ...
    {
        stage.getImagesEffects().paintAlphaImg(g, img, x, y, map.getDisplayableWidth(), map.getDisplayableHeight(), 0, 0, map.getDisplayableWidth()-x, map.getDisplayableHeight()-y, alpha);
    }
